...
preguntas_dict = {
    "Animales":     ["Qué animal tiene manchas negras y blancas?", 
    ...
    "Colores":      ["Qué color se obtiene mezclando rojo y azul?",
                     "Cuál es el color opuesto al verde en el círculo cromático?",
                     "Qué color se obtiene mezclando amarillo y azul?",
                     "Cuál es el color del sol?",
                     "Qué color se obtiene mezclando rojo y amarillo?",
                     "Cuál es el color que representa la pureza?",
                     "Qué color se obtiene mezclando azul y amarillo?",
                     "Cuál es el color del cielo en un día despejado?",
                     "Qué color se obtiene mezclando rojo y blanco?",
                     "Cuál es el color que representa la tristeza?"],
